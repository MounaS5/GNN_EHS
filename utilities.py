...
Original file is located at
    https://colab.research.google.com/drive/1dnZnmu7hPEG9s6ckX5TwPw-iBxWIbjth
"""
...
class restructDataFrame:
    ...
    def restructDB(self,path,db_type,num):#,db_type,num,lst1
      #path = link(self.db_type,self.num,self.lst1)
    ...
    # Initialise dataframe
      ...
      if db_type == 0 and num==4:
        ...
        df = cls.pd.read_table(path, names=('Id','CAS','SMILES', 'Status','Experimental value', 'Predicted value'))
      ...
      if db_type == 0 and num != 4:
        ...
        df1['Predicted value'] = cls.pd.to_numeric(df1['Predicted value'], errors='coerce')
